				...
				<?php foreach ($s['list'] as $key => $item): ?>
					<div class="advantages-item<?= $key % 2 > 0 ? ' advantages-item__reverse' : ''; ?>">
						<div class="advantages-item__img">
							<img data-src="<?= $themeAR->get_src(); ?>/assets/img/advan-triangle1.svg" src="data:image/gif;base64,R0lGODlhAQABAAAAACw=" alt="decor" class="js-img advantages-item__triangle">
